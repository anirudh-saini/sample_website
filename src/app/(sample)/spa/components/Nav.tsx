	...
	return (
		<div className={style.nav}>
			...
			<div className={`${style.nav_menu} ${navOpen ? style.open : ""}`}>
				<ul>
					<li>
						<Link href="/spa/our_services">Our Services</Link>
					</li>
					<li>
						<Link href="/spa/gallery">Gallery</Link>
					</li>
					<li className={style.icon}>
						<img src="/spa/home_icon.svg" />
					</li>
					<li>
						<Link href="/spa/testimonial">Testimonials</Link>
					</li>
					<li>
						<Link href="/spa/">Book a session</Link>
					</li>
				</ul>
			</div>
			<div className={style.nav_img}>
				...
				{data.subheading && (
					<Link href="/spa#scroll" onClick={handleScroll}>
