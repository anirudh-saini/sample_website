        ...
        <div className={style.gallery}>
            ...
            <div className={style.img} ref={parentRef}>
                ...
                <div className={style.item2}>
                    <img src="/ex2.png" alt="image" />
                </div>
                <div className={style.item3}>
                    <img src="/ex3.png" alt="image" />
                </div>
                <div className={style.item4}>
                    <img src="/gallery1.png" alt="image" />
                </div>
                <div className={style.item5}>
                    <img src="/gallery2.png" alt="image" />
                </div>
                <div className={style.item6}>
                    <img src="/ex4.png" alt="image" />
                </div>
                <div className={style.item7}>
                    <img src="/ex5.png" alt="image" />
                </div>
                <div className={style.item8}>
                    <img src="/ex6.png" alt="image" />
                </div>
            </div>
            {/* <div>
                <input
