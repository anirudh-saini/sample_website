        ...
        <div className={style.gallery}>
            ...
            <div className={style.img}>
                <div className={style.item1}>
                    <img src="/gallery3.png" alt="image" />
                </div>
                <div className={style.item2}>
                    <img src="/gallery4.png" alt="image" />
                </div>
                <div className={style.item3}>
                    <img src="/gallery5.png" alt="image" />
                </div>
                <div className={style.item4}>
                    <img src="/gallery6.png" alt="image" />
                </div>
                <div className={style.item5}>
                    <img src="/gallery7.png" alt="image" />
                </div>
                <div className={style.item6}>
                    <img src="/gallery8.png" alt="image" />
                </div>
                <div className={style.item7}>
                    <img src="/gallery9.png" alt="image" />
                </div>
                <div className={style.item8}>
                    <img src="/ex1.png" alt="image" />
                </div>
                <div className={style.item9}>
                    <img src="/gallery10.png" alt="image" />
                </div>
            </div>
            <div>
                <p>
