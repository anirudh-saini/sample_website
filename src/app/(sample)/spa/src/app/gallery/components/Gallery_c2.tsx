        ...
        <div className={style.gallery}>
            ...
            <div className={style.img}>
                <div className={style.item1}>
                    <img src="/gallery11.png" alt="image" />
                </div>
                <div className={style.item2}>
                    <img src="/gallery12.png" alt="image" />
                </div>
                <div className={style.item3}>
                    <img src="/gallery13.png" alt="image" />
                </div>
                <div className={style.item4}>
                    <img src="/gallery14.png" alt="image" />
                </div>
                <div className={style.item5}>
                    <img src="/gallery15.png" alt="image" />
                </div>
                <div className={style.item6}>
                    <img src="/gallery16.png" alt="image" />
                </div>
            </div>
        </div>
    );
