...
export default function Service_with_price() {
    ...
    // const subcarRef = useRef<HTMLDivElement | null>(null);
    // console.log(subcarRef);
    // useEffect(() => {
    //     const scrollInterval = setInterval(() => {
    //         if (!parentRef.current) return;

    //         const scroll = parentRef.current.scrollLeft;
    ...
    const our_service = service.map((item: service, index) => {
        return (
